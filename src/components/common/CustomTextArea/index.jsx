...
import CustomTextInputBasic from "./CustomTextAreaBasic";
import CustomTextAreaBasic from "./CustomTextAreaBasic";

/**
 * Renders a custom input component with below props.
 *
 * @param {Object} props - The props for the CustomTextArea component.
