            ...
            <div className="relative block w-full">
                ...
                >
                    ...
                    >
                        ...
                        {!disabled && (
                            <span className={cssClasses.input}>
                        ...
                        {!disabled && (
                            <span className={cssClasses.icon}>
                                {endIcon?.props?.isPinCodeLoading ? endIcon : <ChevronDownIcon />}
                            </span>
                        )}
                    </div>
                </div>
...
export default CustomSelectBasicStable;
